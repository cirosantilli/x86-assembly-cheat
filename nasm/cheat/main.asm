;
;main cheat on nasm and x86 architecture
;
...
asm_main:
    ...
    ;#flags
        ...
        ;there is a 32 bit register called flag register for which each bit represents a boolean
        ;value with an specific usage
